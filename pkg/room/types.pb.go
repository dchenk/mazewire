...
package room // import "github.com/dchenk/mazewire/pkg/room"
...
func (*Module) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_0ee8627a41169840, []int{0}
}
...
func (*Column) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_0ee8627a41169840, []int{1}
}
...
func (*Common) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_0ee8627a41169840, []int{2}
}
...
func (*Row) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_0ee8627a41169840, []int{3}
}
...
func (*Section) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_0ee8627a41169840, []int{4}
}
...
func (*Tree) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_0ee8627a41169840, []int{5}
}
...
func init() { proto.RegisterFile("room/types.proto", fileDescriptor_types_0ee8627a41169840) }

var fileDescriptor_types_0ee8627a41169840 = []byte{
