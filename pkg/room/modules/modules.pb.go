...
package modules // import "github.com/dchenk/mazewire/pkg/room/modules"

import proto "github.com/golang/protobuf/proto"
import fmt "fmt"
import math "math"
import room "github.com/dchenk/mazewire/pkg/room"
...
func (*NavLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_82ae0b1c95c7d2cd, []int{0}
}
...
func (dst *NavLink) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NavLink.Merge(dst, src)
}
...
func (*Nav) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_82ae0b1c95c7d2cd, []int{1}
}
...
func (dst *Nav) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Nav.Merge(dst, src)
}
...
func (*HTML) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_82ae0b1c95c7d2cd, []int{2}
}
...
func (dst *HTML) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HTML.Merge(dst, src)
}
...
func (*Image) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_82ae0b1c95c7d2cd, []int{3}
}
...
func (*Text) Descriptor() ([]byte, []int) {
	return fileDescriptor_modules_82ae0b1c95c7d2cd, []int{4}
}
...
func init() { proto.RegisterFile("room/modules/modules.proto", fileDescriptor_modules_82ae0b1c95c7d2cd) }

var fileDescriptor_modules_82ae0b1c95c7d2cd = []byte{
